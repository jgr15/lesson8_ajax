    ...
    $(':button').click(function(){
            ...
            ************************************************************************************************/
            ...
            $.ajax({
                ...
                url:'https://api.themoviedb.org/3/search/movie?api_key=33cdb169f0694e0853cad73f3cb5aaf7',
                data: query
            })
            ...
            .done(function(json){
                 ...
                 *********************************Insert Code Below********************************************/                
                //THe following code retrieves the movie title from JSON object retrieved from the TheMovieDB server
                //and places the title on the html page, where the id="original_title".
